...
def format_generated_file(filename: str, content: bytes) -> str:
    ...
    if ext == ".csv":
        try:
            ...
            return f"<p>Error procesando el CSV '{escape(filename)}': {escape(str(e))}.</p>"
        ...
        try:
            ...
            return f"<p>Error procesando el archivo Excel '{escape(filename)}': {escape(str(e))}.</p>"
        ...
        try:
            ...
            return (
                f'<a href="{data_url}" target="_blank" title="Haz clic para ampliar">'
        ...
        try:
            ...
            return f"<p>Error leyendo el archivo de texto '{escape(filename)}': {escape(str(e))}.</p>"
        ...
        try:
            ...
            return f"<p>Error procesando el JSON '{escape(filename)}': {escape(str(e))}.</p>"
